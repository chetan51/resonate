...
MathBox.Animator.prototype={finalState:function(a){var b=_.extend({},a.get());a.__queue&&_.each(a.__queue,function(a,d){_.each(a,function(a){a.to&&(b[d]=a.to)})});return b},attach:function(a){if(!a.__queue){if(!a.__attributes)throw"Cannot attach to object without attributes";var b=this,c=a.set;a.set=function(a,e,g){if(!g){g=a;if(void 0===a||null===a)return;a.constructor==String&&(g={},g[a]=e);b.stop(this,g,!0)}c.call(this,a,e)};a.__queue={};a.__animations=0}},hurry:function(a,b,c){c=c||4;_.each(b||
a.__queue,function(b){_.each(a.__queue[b],function(a){a.hurry(c)})}.bind(this))},stop:function(a,b,c){_.each(b||a.__queue,function(b){for(;a.__queue[b];)this.dequeue(a,b,c)}.bind(this))},animate:function(a,b,c){c=_.extend({duration:300},c||{});this.attach(a);_.each(b,function(b,e){c.immediately&&this.stop(a,[e],!1);var g=a.__queue[e]=a.__queue[e]||[];if(c.delay){var h=new MathBox.Animator.Delay(a,e,c.delay);g.push(h);0==a.__animations++&&this.active.push(a)}a.__validators[e]&&(b=a.__validators[e].call(a,
b));h=new MathBox.Animator.Animation(a,e,b,c.duration,c.callback,c.ease);g.push(h);c.hold&&(h=new MathBox.Animator.Delay(a,e,c.hold),g.push(h),0==a.__animations++&&this.active.push(a));0==a.__animations++&&this.active.push(a)}.bind(this))},dequeue:function(a,b,c){var d=a.__queue[b];if(d){var e=d.shift();0==d.length&&delete a.__queue[b];c&&e.skip();0==--a.__animations&&this.active.splice(this.active.indexOf(a),1)}},update:function(a){MathBox.Animator.now+=a;a=this.active.slice();_.each(a,function(a){var c=
0;_.each(a.__queue,function e(g,h){var k=g[0];value=k.apply(c||0);k.done()&&(c=k.extra(),this.dequeue(a,h),g[0]&&e.call(this,g,h))}.bind(this))}.bind(this))}};MathBox.Animator.Delay=function(a,b,c){this.object=a;this.key=b;this.duration=c;this.fraction=this.start=0};
...
a)e[c]=b[c],h.push(c)});_.each(h,function(a){delete g[a]});e.id==a.get("id")&&(e.id=(e.id||"")+"-clone");a=this.spawn(a.type(),e,{duration:0});this.animate(a,g,c)}.bind(this));return this},hurry:function(a,b,c){var d=this.animator;_.each(this.select(a,!0),function(a){d.hurry(a,b,c);a.style&&d.hurry(a.style,b,c)});return this},halt:function(a,b){var c=this.animator;_.each(this.select(a,!0),function(a){c.stop(a,b,!0);a.style&&c.stop(a.style,b,!0)});return this},viewport:function(a){if(void 0!==a){if(!this._viewport||
