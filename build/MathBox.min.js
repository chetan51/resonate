...
a.__queue,function(b){_.each(a.__queue[b],function(a){a.hurry(c)})}.bind(this))},stop:function(a,b,c){_.each(b||a.__queue,function(b){for(;a.__queue[b];)this.dequeue(a,b,c)}.bind(this))},animate:function(a,b,c){c=_.extend({duration:300},c||{});this.attach(a);_.each(b,function(b,e){c.immediately&&this.stop(a,[e],!1);var f=a.__queue[e]=a.__queue[e]||[];if(c.delay){var h=new MathBox.Animator.Delay(a,e,c.delay);f.push(h);0==a.__animations++&&this.active.push(a)}a.__validators[e]&&(b=a.__validators[e].call(a,
b));h=new MathBox.Animator.Animation(a,e,b,c.duration,c.callback,c.ease);f.push(h);c.hold&&(h=new MathBox.Animator.Delay(a,e,c.hold),f.push(h),0==a.__animations++&&this.active.push(a));0==a.__animations++&&this.active.push(a)}.bind(this))},dequeue:function(a,b,c){var d=a.__queue[b];if(d){var e=d.shift();0==d.length&&delete a.__queue[b];c&&e.skip();0==--a.__animations&&this.active.splice(this.active.indexOf(a),1)}},update:function(a){MathBox.Animator.now+=a;a=this.active.slice();_.each(a,function(a){var c=
0;_.each(a.__queue,function e(f,h){var k=f[0];value=k.apply(c||0);k.done()&&(c=k.extra(),this.dequeue(a,h),f[0]&&e.call(this,f,h))}.bind(this))}.bind(this))}};MathBox.Animator.Delay=function(a,b,c){this.object=a;this.key=b;this.duration=c;this.fraction=this.start=0};
